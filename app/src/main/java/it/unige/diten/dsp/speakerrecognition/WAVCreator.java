...
public class WAVCreator {
    ...
    /**
     * Convert short array into byte array for WAVE use. Format: LSB-MSB.
    ...
    /**
     * Convert byte array into short array. Format LSB-MSB.
     * @param src   Constant byte[] input.
